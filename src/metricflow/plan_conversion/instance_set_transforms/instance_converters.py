...
from metricflow.semantic_interfaces.references import EntityReference, MetricReference, SemanticModelReference
...
from metricflow.semantics.toolkit.assert_one_arg import assert_exactly_one_arg_set
...
class RemoveMetrics(InstanceSetTransform[InstanceSet]):
    ...
    def __init__(self, retained_metric_specs: Iterable[MetricSpec]) -> None:  # noqa: D107
