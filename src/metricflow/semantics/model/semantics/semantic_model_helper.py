...
from metricflow.semantic_interfaces.protocols import Dimension
...
from metricflow.semantic_interfaces.type_enums import DimensionType, EntityType, TimeGranularity
