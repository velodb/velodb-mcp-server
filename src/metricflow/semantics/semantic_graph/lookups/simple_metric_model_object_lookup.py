...
from metricflow.semantic_interfaces.protocols import Metric, SemanticModel
from metricflow.semantic_interfaces.type_enums import DimensionType, MetricType, TimeGranularity
from metricflow.semantics.errors.error_classes import InvalidManifestException, MetricFlowInternalError
from metricflow.semantics.model.semantics.simple_metric_input import (
    SimpleMetricInput,
    SimpleMetricInputAggregation,
    SimpleMetricInputNonAdditiveDimension,
)
from metricflow.semantics.semantic_graph.lookups.model_object_lookup import ModelObjectLookup
from metricflow.semantics.toolkit.dataclass_helpers import fast_frozen_dataclass
from metricflow.semantics.toolkit.mf_logging.attribute_pretty_format import AttributeMapping
