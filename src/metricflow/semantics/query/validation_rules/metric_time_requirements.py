...
from metricflow.semantic_interfaces.protocols import Metric, WhereFilterIntersection
...
from metricflow.semantics.query.issues.parsing.cumulative_metric_requires_metric_time import (
    CumulativeMetricRequiresMetricTimeIssue,
)
from metricflow.semantics.query.issues.parsing.offset_metric_requires_metric_time import (
    OffsetMetricRequiresMetricTimeIssue,
)
from metricflow.semantics.query.resolver_inputs.query_resolver_inputs import ResolverInputForQuery
from metricflow.semantics.query.validation_rules.base_validation_rule import PostResolutionQueryValidationRule
...
if typing.TYPE_CHECKING:
    from metricflow.semantics.query.query_resolver import ResolveGroupByItemsResult, ResolveMetricsResult
