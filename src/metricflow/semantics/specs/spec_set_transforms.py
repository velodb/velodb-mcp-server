...
from metricflow.semantics.specs.spec_set import InstanceSpecSet, InstanceSpecSetTransform
...
class ToElementNameSet(InstanceSpecSetTransform[Set[str]]):
    ...
    def transform(self, spec_set: InstanceSpecSet) -> Set[str]:  # noqa: D102
        return (
            ...
            .union({x.element_name for x in spec_set.simple_metric_input_specs})
