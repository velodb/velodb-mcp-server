...
from metricflow.semantic_interfaces.protocols.query_interface import (
    QueryInterfaceTimeDimensionFactory,
)
from metricflow.semantic_interfaces.references import EntityReference, TimeDimensionReference
...
from metricflow.semantics.specs.where_filter.where_filter_dimension import WhereFilterDimension
