...
from metricflow.semantic_interfaces.protocols.dimension import Dimension, DimensionType
from metricflow.semantic_interfaces.protocols.entity import Entity
from metricflow.semantic_interfaces.references import (
    EntityReference,
    SemanticModelElementReference,
    SemanticModelReference,
)
from metricflow.semantic_interfaces.type_enums.date_part import DatePart
...
from metricflow.semantics.specs.simple_metric_input_spec import SimpleMetricInputSpec
from metricflow.semantics.specs.time_dimension_spec import DEFAULT_TIME_GRANULARITY, TimeDimensionSpec
