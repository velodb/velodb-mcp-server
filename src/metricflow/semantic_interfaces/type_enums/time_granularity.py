...
from metricflow.semantic_interfaces.enum_extension import ExtendedEnum, assert_values_exhausted
...
class TimeGranularity(ExtendedEnum):
    ...
    def is_smaller_than(self, other: TimeGranularity) -> bool:  # noqa: D102
        return self.to_int() < other.to_int()

    def is_smaller_than_or_equal(self, other: TimeGranularity) -> bool:  # noqa: D102
        return self.to_int() <= other.to_int()

    def __lt__(self, other: Any) -> bool:  # type: ignore [misc] # noqa: D105
