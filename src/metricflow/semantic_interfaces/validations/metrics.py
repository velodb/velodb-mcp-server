...
from metricflow.semantic_interfaces.protocols import (
...
from metricflow.semantic_interfaces.protocols.metric import MetricInput
...
from metricflow.semantic_interfaces.type_enums import (
    AggregationType,
    MetricType,
    TimeGranularity,
)
from metricflow.semantic_interfaces.validations.shared_measure_and_metric_helpers import (
    SharedMeasureAndMetricHelpers,
)
from metricflow.semantic_interfaces.validations.unique_valid_name import UniqueAndValidNameRule
...
from metricflow.semantic_interfaces.validations.where_filters import (
