...
from metricflow.msi_pydantic_shim import BaseModel, create_model
...
# Any Pydantic object  # type: ignore[misc]
PydanticT = TypeVar("PydanticT", bound=Type[BaseModel])
# Any value  # type: ignore[misc]
...
class DataclassSerializer:
    ...
    def pydantic_serialize(self, obj: SerializableDataclassT) -> str:  # noqa: D102
...
class DataClassDeserializer:
    ...
    def pydantic_deserialize(  # noqa: D102
...
class DataClassTypeToPydanticTypeConverter:  # noqa: D101
    ...
    def to_pydantic_type(self, dataclass_type: Type[SerializableDataclass]) -> Type[BaseModel]:  # noqa: D102
...
class FieldDefinition:
    ...
    def as_pydantic_field_tuple(self) -> Tuple[Type, AnyValueType]:
        """Pydantic fields can be initialized with a Tuple[Type, Any], the second parameter is the default value."""  # type: ignore[misc]
        default = self.default_value if self.default_value != dataclasses.MISSING else ...
        return (self.annotated_field_type, default)

    @property
    def annotated_field_type(self) -> Type:  # noqa: D102
