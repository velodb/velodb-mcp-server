...
from metricflow.msi_pydantic_shim import BaseModel, root_validator
...
# Type alias for the implicit "Any" type used as input and output for Pydantic's parsing API  # type: ignore[misc]
...
class PydanticCustomInputParser(ABC, Generic[ModelObjectT_co]):
    ...
    processed and validated in the standard Pydantic way. Any subclass needing to mutate the inputs from a dict  # type: ignore[misc]
