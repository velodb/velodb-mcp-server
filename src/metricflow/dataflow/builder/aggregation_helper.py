...
from metricflow.semantics.specs.simple_metric_input_spec import SimpleMetricInputSpec, SimpleMetricRecipe
from metricflow.semantics.toolkit.collections.mapping_helpers import mf_common_keys
